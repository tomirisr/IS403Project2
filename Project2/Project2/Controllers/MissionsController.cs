...
namespace Project2.Controllers
{
    public class MissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MissionID,MissionName,MissionPresident,MissionAddress,City,Country,DominantReligion,Flag")] Mission mission)
        {
